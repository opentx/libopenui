...
#define KEYBOARD_DELETE        "\006"
#define KEYBOARD_HOME          "\007"
#define KEYBOARD_END           "\008"
#endif

enum SpecialKey
{
  SPECIAL_KEY_BACKSPACE = KEYBOARD_BACKSPACE[0],
  SPECIAL_KEY_SET_UPPERCASE = KEYBOARD_SET_UPPERCASE[0],
  SPECIAL_KEY_SET_LOWERCASE = KEYBOARD_SET_LOWERCASE[0],
  SPECIAL_KEY_SET_LETTERS = KEYBOARD_SET_LETTERS[0],
  SPECIAL_KEY_SET_NUMBERS = KEYBOARD_SET_NUMBERS[0],
  SPECIAL_KEY_SPACE = KEYBOARD_SPACE[0],
  SPECIAL_KEY_ENTER = KEYBOARD_ENTER[0],
#if defined(SIMULATION)
  SPECIAL_KEY_DELETE = KEYBOARD_DELETE[0],
  SPECIAL_KEY_HOME = KEYBOARD_HOME[0],
  SPECIAL_KEY_END = KEYBOARD_END[0],
#endif
};
